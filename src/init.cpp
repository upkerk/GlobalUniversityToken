...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/upkerk/globaluniversitytoken>";
    const std::string URL_WEBSITE = "<https://globaluniversitytoken.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Globaluniversitytoken version %s\n", FormatFullVersion());
}
