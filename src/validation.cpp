...
#if defined(NDEBUG)
# error "Globaluniversitytoken cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Globaluniversitytoken Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s GUT additional fees, %d delta bytes\n",
