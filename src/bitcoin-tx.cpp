...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s globaluniversitytoken-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  globaluniversitytoken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded globaluniversitytoken transaction") + "\n" +
              "  globaluniversitytoken-tx [options] -create [commands]   " + _("Create hex-encoded globaluniversitytoken transaction") + "\n" +
              "\n";
